...
|:--------------------|:---------------------------------------------------------|
|Delegated (work or school account) | User.ReadWrite.All, Directory.ReadWrite.All, Directory.AccessAsUser.All. In addition, users need to be assigned one of the Azure AD admin roles that can create users (i.e. Global admin or User Account admin).    |
